...
export function CustomLeftArrow(props: {
  ...
  return (
    <div>
      <span
        className="bg-red-500 absolute top-1/2 left-40 transform -translate-y-1/2 bg-white bg-opacity-50 text-black p-2 rounded-full hover:bg-opacity-75 border border-[#E6E6E6]"
