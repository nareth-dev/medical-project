...
const CoreValueCard = () => {
  const coreValues = [
    {
      icon: "/images/about/icon-pointer.svg",
      title: "Platform",
      description:
    ...
    {
      icon: "/images/about/pulbs-icon.svg",
    ...
    {
      icon: "/images/about/feature-icon.svg",
      title: "Features",
      description:
        ...
        <div className="w-full md:container mx-auto mt-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-5 mt-10">
            {coreValues.map((value, index) => (
              <div
                key={index}
                className="w-full p-[24px] rounded-md shadow-md mb-20"
              >
                <div className="bg-[#E5E8E8] flex w-12 h-12 justify-center items-center rounded-full">
                  <Image
                    src={value.icon}
                    alt={value.title}
                    width={30}
